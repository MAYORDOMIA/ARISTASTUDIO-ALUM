...
function cleanFile(f) {
  ...
  c = c.replace(/\/\/ Redistribute total width equally among all columns[^]*(?=setComposition)/g, '/* width all */');
  c = c.replace(/\/\/ Redistribute total width equally among[^]*(?=setComposition)/g, '/* width */');
  c = c.replace(/\/\/ Redistribute total height equally among all rows[^]*(?=setComposition)/g, '/* height all */');
  c = c.replace(/\/\/ Redistribute total height equally among[^]*(?=setComposition)/g, '/* height */');
