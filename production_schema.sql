...
BEGIN
    ...
    INSERT INTO public.materiales_perfiles_usuario (user_id, master_ref, code, detail, weight_per_meter, bar_length, is_glazing_bead)
    SELECT NEW.id, id, code, detail, weight_per_meter, bar_length, is_glazing_bead
