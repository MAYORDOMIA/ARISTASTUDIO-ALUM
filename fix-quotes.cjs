...
c = c.replace(/\/\/ For double doors, leaf 0 opens left \(to the right vertex\) and leaf 1 opens right \(to the left vertex\) if/g, '/* doors */ if');
...
c = c.replace(/\/\/ Si están en la misma línea Y y están ce if/g, '/* Si estan en Y */ if');
