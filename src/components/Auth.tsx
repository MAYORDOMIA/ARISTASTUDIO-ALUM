  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error;
        /* Intentar crear el perfil manualmente si RLS lo permite (o dejar que el trigger lo haga) */ if (
          data?.user
        ) {
            ...
            .insert([
              {
                ...
                role:
                  email === "aristastudiouno@gmail.com"
                    ? "super_admin"
                    : "user",
          ...
          if (profileError) {
            console.error(
              "Error al crear el perfil (msg):",
              profileError?.message || profileError,
            );
          }
        }
        setMessage(
          "Registro exitoso. Por favor, espera a que un administrador active tu cuenta.",
        );
      }
    } catch (err: any) {
      ...
      <div className="w-full max-w-md bg-white ] rounded-3xl shadow-xl border border-slate-200 p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-2">
            {isLogin
              ? "Inicia sesión para acceder al cotizador"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-sky-500 "
